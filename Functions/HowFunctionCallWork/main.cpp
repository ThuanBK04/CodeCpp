 ...
 * Function use the 'function call back'
 ...
 * Local variables and funcion parameters are allocated on the stack
 * 
...
/*
   ...
   Analysize the example bellow:
   What typically happens when mains func1 (or any function calls another)
