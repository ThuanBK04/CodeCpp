...
ProjectPath            :=D:/11_LaptrinhCpp/CodeCpp/Section13_Opp_ClassObject/ImplementingMemberMethod
IntermediateDirectory  :=../build-$(WorkspaceConfiguration)/ImplementingMemberMethod
...
SourceSwitch           :=-c 
OutputDirectory        :=D:/11_LaptrinhCpp/CodeCpp/Section13_Opp_ClassObject/build-$(WorkspaceConfiguration)/bin
...
$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/11_LaptrinhCpp/CodeCpp/Section13_Opp_ClassObject/ImplementingMemberMethod/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Account.cpp$(PreprocessSuffix): Account.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Account.cpp$(PreprocessSuffix) Account.cpp

$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/11_LaptrinhCpp/CodeCpp/Section13_Opp_ClassObject/ImplementingMemberMethod/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
